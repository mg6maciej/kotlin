...
abstract class AbstractKtReference<T : KtElement>(element: T) : PsiPolyVariantReferenceBase<T>(element), KtReference {
    ...
    override fun multiResolve(incompleteCode: Boolean): Array<ResolveResult> {
        ...
        return ResolveCache.getInstance(expression.project).resolveWithCaching(this, KOTLIN_RESOLVER as ResolveCache.PolyVariantResolver<AbstractKtReference<T>>, false, true)
    }
